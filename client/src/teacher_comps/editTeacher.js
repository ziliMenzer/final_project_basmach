...
import "../student_comps/myInfo.css";
                                    ...
                                    <div className="card-body p-4">
                                        <form onSubmit={handleSaveClick}>
                                            ...
                                            <div className="row pt-1">
                                                <div className="col-6 mb-3">
                                                    <h6>מחיר לשיעור</h6>
                                                    <p className="text-muted">{user.payment_per_lesson} ₪</p>
                                                </div>
                                                <div className="col-6 mb-3">
                                                    <h6>סוג רישיון</h6>
                                                    <p className="text-muted">{user.license_type}</p>
                                                </div>
                                            </div>
                                            {isEditing ? (
                                                <>
                                                    <button className='btn-form p-2 rounded-pill' type="submit" onClick={handleSaveClick}>שמירה</button>
                                                    <button className='btn-form p-2 mx-2 rounded-pill' type="button" onClick={() => setIsEditing(false)}>ביטול</button>
                                                </>
                                            ) : (
