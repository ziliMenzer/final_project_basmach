    ...
    return (
        <>
            <div>
                ...
                {errors.payment_per_lesson && errors.payment_per_lesson.type == 'required' && <div className='text-white font-bold bg-red-800 border-gray-300  py-1'>{errors?.payment_per_lesson?.message}</div>}
            </div>
        </>
    )
}
